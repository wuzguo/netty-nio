...
import com.sunvalley.io.p2p.chat.business.ServerMessageHandler;
...
public class P2PAuthServerChannelInitializer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        pipeline.addLast("authServerHandler", new P2PAuthServerHandler());
    }
}
